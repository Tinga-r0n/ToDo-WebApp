...
<button id="startButton${task.id}" class="btn btn-primary btn-sm start-btn" 
        onclick="changeTaskStatus('${task.id}', 'IN PROGRESS')" 
        style="margin-left: 10px; display: ${currentStatus === 'TODO' ? 'inline-block' : 'none'};">
    Start
</button>
            ...
            <td style="padding: 0; border: none;">
                ...
                " class="${currentStatus === "COMPLETED" ? "completed-task" : ""}">
                    ...
                    <h6 class="mb-0" id="statusBadge${task.id}">
                      ...
                      ${isDelayed ? `<span style="color: red; font-weight: bold;">Delayed</span>` : ""}
                         ${
            task.is_unplaned === 1
                ? `<label style="padding-top: 5px; font-size: 10px; color: red; max-width: 120px; font-weight: bold;">
                    Unplanned Task
